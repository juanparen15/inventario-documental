        ...
        return [
            'plugins' => [
                ...
                'tooltip' => [
                    ...
                    'displayColors'   => false,
                    'callbacks'       => [
                        // Muestra el mes/año completo como título
                        ...
                        // Muestra el conteo con texto descriptivo
                        'label' => "function(ctx){ var n=ctx.raw; return '  '+n+(n===1?' acto registrado':' actos registrados'); }",
                    ],
                ],
            ],
            'scales' => [
