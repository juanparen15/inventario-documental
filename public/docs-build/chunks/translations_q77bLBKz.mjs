...
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, p as renderUniqueStylesheet, q as renderScriptElement, t as createHeadAndContent, r as renderComponent, a as AstroUserError } from './astro/server_DO_nUfqZ.mjs';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CVTtHqHr.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/docs", "DEV": false, "MODE": "production", "PROD": true, "SITE": "http://localhost:8000", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CIEAjd90.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_SnioEqPr.mjs');
...
const starlightConfig = {"logo":{"src":"./src/assets/favicon.svg","alt":"Logo","replacesTitle":false},"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Inicio","translations":{},"collapsed":false,"autogenerate":{"directory":"inicio","attrs":{}}},{"label":"Instalación","translations":{},"collapsed":false,"autogenerate":{"directory":"instalacion","attrs":{}}},{"label":"Manual de Usuario","translations":{},"collapsed":false,"autogenerate":{"directory":"usuario","attrs":{}}},{"label":"Roles","translations":{},"collapsed":false,"autogenerate":{"directory":"roles","attrs":{}}},{"label":"Referencia","translations":{},"collapsed":false,"autogenerate":{"directory":"referencia","attrs":{}}},{"label":"Documentación Técnica","translations":{},"collapsed":false,"autogenerate":{"directory":"tecnica","attrs":{}}}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"Inventario Documental"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///C:/laragon/www/inventario-documental/public/docs/","srcDir":"file:///C:/laragon/www/inventario-documental/public/docs/src/","trailingSlash":"ignore"};
